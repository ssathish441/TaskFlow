...
class SignUpModel {
   ...
   SignUpModel(SignUpView var1) {
      this.signUpView = var1;
   }
   ...
   List<Employee> getActiveManagers() {
      return TaskFlowDB.getInstance().getActiveManagers();
   }

   void registerEmployee(String var1, String var2, String var3, String var4, Long var5, Employee.Role var6, Long var7) {
      ...
      if (var9 == null) {
         this.signUpView.showErrorMessage("Could not create account. Please try again.");
      } else {
         this.signUpView.onSignUpSuccessful(var9);
      }
   }
}
